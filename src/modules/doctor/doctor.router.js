...
router.post('/signup',auth(endPoint.addDoctor),fileUpload(fileValidation.image).single('image'),
validation(validationdoctor.signup),asyncHandler(doctorController.signup))
